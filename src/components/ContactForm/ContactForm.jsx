        ...
        <div className="lg:w-1/3 md:w-1/2 bg-green-700 bg-opacity-60 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
          ...
          <div className="relative mb-4 ">
            ...
            <input
              ...
              className="w-full bg-white bg-transparent rounded border border-gray-300 focus:border-green-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-white py-1 px-3 leading-8 transition-colors duration-200 ease-in-out placeholder-gray-200"
            />
          </div>
          <div className="relative mb-4">
